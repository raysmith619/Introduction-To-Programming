# bouncing_ball.py  17Feb2022  crs, Author
"""
...
### Setup access to enable clean window closing
...
def ball_edge_check():
    """ Adjust motion if/when edge touched
        Simple physics of edge collision says
            1. The velocity parallel to the edge
               remains unchanged.
            2. The velocity perpendicular to the
               edge is reversed.
    ...
    if collision:
        ...
        if n_collision >= ncol_to_restart:
            ...
            # The function ontimer() prepares
            # for the routine to be
