...
def collect_file(file_name, meas_list=None):
    """ Collect file and add to measures
    :file_name:  file to process
    :meas_list: list into which to add measurements
            default: smeasures
    """
...
for file_name in data_files:
    collect_file(file_name, smeasures)
data_count = len(smeasures)
