# bouncing_balls_game_5.py  03Apr2024  crs, from bouncing_balls_3.py
"""
Simple program to demonstrate class development
Using:
    -- Determine collision, keep track of collisions
...
class BouncingBallGame:
    ...
    def ball_edge_check(self, ball):
        ...
        collision = False       # -- Remember if any collision
        ...
        if collision:
            ball.n_collision += 1   # -- count collisions, 
            ball.ball_color_index = (
                ball.ball_color_index+1)%len(ball.colors    # -- ==> color
                )
