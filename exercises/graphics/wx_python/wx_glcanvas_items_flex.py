#wx_glcanvas_items_flex.py
#                           18Oct2023  crs, from wx_canvas_items_flex.py
#                           08Jun2023  crs, from canvas_items.py
#canvas_items.py    23Oct2022  crs, From resource_lib_proj/
"""
Using wx.glcanvas.GLCanvas(Window)
...
class WXGlCanvas(wx.glcanvas.GLCanvas):
    def __init__(self, *args, **kw):
        super(wx.Window, self).__init__(*args, **kw)
...
cvf = WXGlCanvas(None)         # Alternative - master frame instead of master window
